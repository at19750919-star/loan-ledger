 ...
 *
 * 範例：
 *   備註「蔡O姐」+ 70000 → 五股蔡小姐(長期)
 *   備註「蔡O姐」+ 40000 → 五股蔡小姐(短期)
 *   備註「王O哲」+ 60000 → 台中王浩哲
...
function testMatching() {
  ...
  const samples = [
    { type: '轉入', amount: 70000,  remark: '蔡O姐',    date: '2026/04/24' }, // → 五股蔡小姐(長期)
    { type: '轉入', amount: 40000,  remark: '蔡O姐',    date: '2026/04/24' }, // → 五股蔡小姐(短期)
